...
export default function ProductDetail() {
  ...
  useEffect(() => {
    ...
    if (foundProduct) {
      ...
      if (
        foundProduct.diamondQualities &&
        foundProduct.diamondQualities.length > 0
      )
        setSelectedDiamondQuality(foundProduct.diamondQualities[0]);
      ...
      if (foundProduct.colorImages && foundProduct.colorImages[defaultColor]) {
        ...
        setCurrentImages(
          foundProduct.images && foundProduct.images.length
            ? foundProduct.images
        ...
        <div className="product-detail-grid">
          ...
          <div className="product-gallery">
            <div className="main-image-container">
              <img
                src={currentImages[activeImg] || product.images?.[0]}
                alt={product.name}
          ...
          <div className="product-main-info">
            <div className="info-header">
              <div className="category-tags">
                {(product.category || []).map((cat) => (
                  <span key={cat} className="detail-cat-tag">
                    {cat}
                  </span>
                ))}
                ...
                <div className="stars">
                  {[...Array(5)].map((_, i) => (
                    <Star
                      key={i}
                      size={14}
                      fill={i < 4 ? "var(--gold-primary)" : "none"}
            ...
            {product.diamondQualities && (
              <div className="selector-section">
                ...
                <p className="dq-helper">
                  All diamonds are crafted in VVS VS clarity with FG color.
                </p>
              </div>
            )}
            ...
            {product.colors && (
              <div className="selector-section">
                <h3 className="selector-title">
                  Metal Color :{" "}
                  <span className="selected-val-text">{selectedColor}</span>
                </h3>
            ...
            {product.sizes && (
              <div className="selector-section">
                <div className="selector-header">
                  <h3 className="selector-title">
                    Ring Size :{" "}
                    <span className="selected-val-text">{selectedSize}</span>
                  </h3>
            ...
            <div className="product-accordions">
                ...
                <div className="accordion-content">
                  <table className="specs-table">
                    <tbody>
                      ...
                      <tr>
                        <td>
                          Gold Weight ( Approx ) <Share2 size={12} />
                        </td>
                      ...
                      <tr>
                        <td>
                          Height <Share2 size={12} />
                        </td>
                        <td>{product.details?.height}</td>
                      </tr>
                      <tr>
                        <td>
                          Width <Share2 size={12} />
                        </td>
              ...
              <div
                className={`accordion-item ${openSection === "diamond" ? "open" : ""}`}
              >
                <button
                  className="accordion-trigger"
                  onClick={() =>
                    setOpenSection(openSection === "diamond" ? "" : "diamond")
                  }
                >
                ...
                <div className="accordion-content">
                  <p>
                    Detailed information about secondary diamonds used in this
                    piece.
                  </p>
                </div>
              </div>
              ...
              <div
                className={`accordion-item ${openSection === "price" ? "open" : ""}`}
              >
                <button
                  className="accordion-trigger"
                  onClick={() =>
                ...
                <div className="accordion-content">
                  <p>
                    Transparent breakdown of gold, diamond, and making charges.
                  </p>
                </div>
              </div>
            </div>
